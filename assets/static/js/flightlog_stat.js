...
var flightlogStat = function () {
    ...
    var handleTable = function (opt) {
        ...
        var engineTimeExtras = opt.engineTimeExtras;
        ...
        var hot = new Handsontable(container, {
            ...
            afterInit: function () {
                ...
                if (data.length > 0) {
                    ...
                    var _landings_data = [];
                    for (var idx = 0; idx < data.length; idx++) {
                        _flighttime_data.push(data[idx][11]);
                        _enginetime_data.push(data[idx][12]);
                        _landings_data.push(data[idx][16]);
                    }
                    _enginetime_data = _enginetime_data.concat(engineTimeExtras);
