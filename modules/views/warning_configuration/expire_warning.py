...
class ExpireWaringConfigurationView(BaseView):
    """航材预警服务配置页面"""

    def __init__(self, *args, **kwargs):
        self._template = 'maturity_warning/expire_warning.html',
        super(ExpireWaringConfigurationView, self).__init__(
            name='到期预警信息配置',
            endpoint='expirewarning_configuration',
            **kwargs)
    ...
    def index(self):
        ...
        warn = CheckWarning(current_app.redis_cache, 'expirewarning')
        warn.get_form(form)
        warn.get_value()
        warn.out_put()
