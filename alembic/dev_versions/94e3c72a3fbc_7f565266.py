...
Revision ID: 94e3c72a3fbc
Revises: 726f5777c286
Create Date: 2017-11-21 15:46:40.363966
...
revision = '94e3c72a3fbc'
down_revision = '726f5777c286'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('file_resource_version', 'addTime',
               ...
               existing_nullable=True,
               autoincrement=False)
    op.add_column('loan_return_order', sa.Column('loanCategory', sa.String(length=255), nullable=True))
    op.drop_column('loan_return_order', 'instoreCategory')
    op.add_column('loan_return_order_version', sa.Column('loanCategory', sa.String(length=255), autoincrement=False, nullable=True))
    op.drop_column('loan_return_order_version', 'instoreCategory')
...
def downgrade():
    ...
    op.alter_column('user', 'active',
               ...
               existing_nullable=True)
    op.add_column('loan_return_order_version', sa.Column('instoreCategory', mysql.VARCHAR(length=255), nullable=True))
    op.drop_column('loan_return_order_version', 'loanCategory')
    op.add_column('loan_return_order', sa.Column('instoreCategory', mysql.VARCHAR(length=255), nullable=True))
    op.drop_column('loan_return_order', 'loanCategory')
    op.alter_column('file_resource_version', 'addTime',
