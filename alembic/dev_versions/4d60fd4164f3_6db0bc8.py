...
Revision ID: 4d60fd4164f3
Revises: 1b659744a825
Create Date: 2017-11-29 20:15:04.719803
...
revision = '4d60fd4164f3'
down_revision = '1b659744a825'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('airmaterial_category', 'category',
               existing_type=mysql.VARCHAR(length=255),
               nullable=False)
    op.alter_column('airmaterial_category', 'name',
               existing_type=mysql.VARCHAR(length=255),
               nullable=False)
    op.alter_column('airmaterial_category', 'partNumber',
               existing_type=mysql.VARCHAR(length=255),
               nullable=False)
    op.create_unique_constraint(None, 'airmaterial_category', ['partNumber'])
...
def downgrade():
    ...
    op.alter_column('basic_action', 'approve',
               ...
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=True)
    op.drop_constraint(None, 'airmaterial_category', type_='unique')
    op.alter_column('airmaterial_category', 'partNumber',
               existing_type=mysql.VARCHAR(length=255),
               nullable=True)
    op.alter_column('airmaterial_category', 'name',
