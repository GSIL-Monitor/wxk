...
Revision ID: 726f5777c286
Revises: 7c4e1c605f6e
Create Date: 2017-11-17 14:55:25.212555
...
revision = '726f5777c286'
down_revision = '7c4e1c605f6e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('basic_action', sa.Column('in_store_finish', sa.Boolean(), nullable=True))
    op.add_column('basic_action', sa.Column('in_store_part', sa.Boolean(), nullable=True))
    op.add_column('basic_action', sa.Column('out_store_finish', sa.Boolean(), nullable=True))
    op.add_column('basic_action', sa.Column('out_store_part', sa.Boolean(), nullable=True))
    ...
    op.alter_column('file_resource_version', 'addTime',
               ...
               existing_nullable=True,
               autoincrement=False)
    op.alter_column('sub_formula', 'weight',
...
def downgrade():
    ...
    op.alter_column('basic_action', 'approve',
               ...
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=True)
    op.drop_column('basic_action', 'out_store_part')
    op.drop_column('basic_action', 'out_store_finish')
    op.drop_column('basic_action', 'in_store_part')
    op.drop_column('basic_action', 'in_store_finish')
    # ### end Alembic commands ###
