...
Revision ID: 7c4e1c605f6e
Revises: a1ea71247d0a
Create Date: 2017-11-15 17:30:32.839518
...
revision = '7c4e1c605f6e'
down_revision = 'a1ea71247d0a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('basic_action', 'view',
               ...
               type_=sa.Boolean(),
               existing_nullable=True)
    op.alter_column('disassemble_order', 'date',
               existing_type=mysql.DATETIME(),
               type_=sa.String(length=255),
               existing_nullable=False)
    op.alter_column('disassemble_order', 'disassembleDate',
               existing_type=mysql.DATETIME(),
               type_=sa.String(length=255),
               existing_nullable=False)
    op.alter_column('disassemble_order_version', 'date',
               existing_type=mysql.DATETIME(),
               type_=sa.String(length=255),
               existing_nullable=True,
               autoincrement=False)
    op.alter_column('disassemble_order_version', 'disassembleDate',
               existing_type=mysql.DATETIME(),
               type_=sa.String(length=255),
               existing_nullable=True,
               autoincrement=False)
    ...
    op.alter_column('file_resource_version', 'addTime',
               ...
               existing_nullable=True,
               autoincrement=False)
    op.add_column('loan_return_order', sa.Column('borrowCompany', sa.String(length=255), nullable=True))
    op.drop_column('loan_return_order', 'returnCompany')
    op.add_column('loan_return_order_version', sa.Column('borrowCompany', sa.String(length=255), autoincrement=False, nullable=True))
    op.drop_column('loan_return_order_version', 'returnCompany')
    op.add_column('put_out_store', sa.Column('borrowCompany', sa.String(length=255), nullable=True))
    op.drop_column('put_out_store', 'companyName')
    op.add_column('put_out_store_version', sa.Column('borrowCompany', sa.String(length=255), autoincrement=False, nullable=True))
    op.drop_column('put_out_store_version', 'companyName')
    op.add_column('storage_list', sa.Column('planeNum', sa.String(length=255), nullable=True))
...
def downgrade():
    ...
    op.alter_column('user', 'active',
               ...
               existing_nullable=True)
    op.drop_column('storage_list', 'planeNum')
    op.add_column('put_out_store_version', sa.Column('companyName', mysql.VARCHAR(length=255), nullable=True))
    op.drop_column('put_out_store_version', 'borrowCompany')
    op.add_column('put_out_store', sa.Column('companyName', mysql.VARCHAR(length=255), nullable=True))
    op.drop_column('put_out_store', 'borrowCompany')
    op.add_column('loan_return_order_version', sa.Column('returnCompany', mysql.VARCHAR(length=255), nullable=True))
    op.drop_column('loan_return_order_version', 'borrowCompany')
    op.add_column('loan_return_order', sa.Column('returnCompany', mysql.VARCHAR(length=255), nullable=True))
    op.drop_column('loan_return_order', 'borrowCompany')
    op.alter_column('file_resource_version', 'addTime',
