...
Revision ID: c2577c102715
Revises: d3cfcb82e250
Create Date: 2018-06-13 13:48:15.608042
...
revision = 'c2577c102715'
down_revision = 'd3cfcb82e250'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('flight_log', 'weight',
    ...
    op.alter_column('flight_log_version', 'weight',
               existing_type=mysql.INTEGER(display_width=11),
               type_=sa.String(length=255),
               existing_nullable=True,
               autoincrement=False)
    op.alter_column('repair_material', 'totalUseTime',
               ...
               type_=sa.String(length=255),
               existing_nullable=True)
    op.alter_column('train_record', 'trainRecordScore',
               existing_type=mysql.INTEGER(display_width=11),
               type_=sa.String(length=255),
               existing_nullable=True)
    op.alter_column('train_record_version', 'trainRecordScore',
               existing_type=mysql.INTEGER(display_width=11),
               type_=sa.String(length=255),
               existing_nullable=True,
               autoincrement=False)
